<?php $__env->startSection('title', 'Tentang Perpustakaan'); ?>
...
<div class="mx-auto max-w-4xl px-4 py-10 sm:px-6 lg:px-8">
    ...
    <p class="mt-2 text-sm text-gray-500"><?php echo e($pengaturan->nama_perpustakaan); ?> &mdash; Cerdas, Beriman, dan Mandiri.</p>
    ...
    <div class="mt-8 space-y-8">
        ...
        <section>
            ...
            <p class="text-sm text-gray-600"><?php echo e($pengaturan->jam_pelayanan); ?></p>
        </section>
        <section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\perpustakaan_sanpedro\resources\views/public/tentang.blade.php ENDPATH**/ ?>