...
<div class="mx-auto flex min-h-[70vh] max-w-md flex-col justify-center px-4 py-10 sm:px-6">
    <div class="card p-8">
        <div class="mb-6 text-center">
            <img src="{{ asset('images/logo-universitas.png') }}" alt="Logo" class="mx-auto h-14 w-14 rounded-full object-cover" onerror="this.src='{{ asset('images/logo-placeholder.png') }}'">
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-4">
            ...
            <div>
                ...
                <input type="email" name="email" value="{{ old('email') }}" required autofocus class="input" placeholder="nama@sanpedro.ac.id">
            </div>
            <div>
